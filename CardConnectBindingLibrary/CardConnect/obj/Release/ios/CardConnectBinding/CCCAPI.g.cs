...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = true, Name = "Instance", Selector = "instance", ReturnType = typeof (CardConnectBinding.CCCAPI))]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GenerateAccountForCard", Selector = "generateAccountForCard:completion:", ReturnType = typeof (NSUrlSessionTask), ParameterType = new Type [] { typeof (CardConnectBinding.CCCCardInfo), typeof (global::System.Action<global::CardConnectBinding.CCCAccount, NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V0) })]
