...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "PaymentRequest", Selector = "paymentRequest", PropertyType = typeof (CardConnectBinding.CCCPaymentRequest), GetterSelector = "paymentRequest", SetterSelector = "setPaymentRequest:", ArgumentSemantic = ArgumentSemantic.Retain)]
...
namespace CardConnectBinding {
	...
	public unsafe partial class CCCPaymentController : NSObject, ICCCPaymentController {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CCCPaymentController (global::UIKit.UIViewController rootView, CCCAPIBridgeProtocol bridge, CCCPaymentControllerDelegate del)
			: base (NSObjectFlag.Empty)
		{
			...
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("initWithRootView:apiBridge:delegate:"), rootView.Handle, bridge.Handle, del.Handle), "initWithRootView:apiBridge:delegate:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("initWithRootView:apiBridge:delegate:"), rootView.Handle, bridge.Handle, del.Handle), "initWithRootView:apiBridge:delegate:");
			}
		}
		
		[Export ("initWithRootView:apiBridge:delegate:theme:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CCCPaymentController (global::UIKit.UIViewController rootView, CCCAPIBridgeProtocol bridge, CCCPaymentControllerDelegate del, CCCTheme theme)
			: base (NSObjectFlag.Empty)
		{
			if (rootView == null)
				throw new ArgumentNullException ("rootView");
			...
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("initWithRootView:apiBridge:delegate:theme:"), rootView.Handle, bridge.Handle, del.Handle, theme == null ? IntPtr.Zero : theme.Handle), "initWithRootView:apiBridge:delegate:theme:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr_IntPtr_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("initWithRootView:apiBridge:delegate:theme:"), rootView.Handle, bridge.Handle, del.Handle, theme == null ? IntPtr.Zero : theme.Handle), "initWithRootView:apiBridge:delegate:theme:");
			}
		}
