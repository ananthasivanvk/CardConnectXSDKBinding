...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "IsValidCVVWithCardFormatter", Selector = "isValidCVVWithCardFormatter:", ReturnType = typeof (bool), ParameterType = new Type [] { typeof (CardConnectBinding.CCCCardFormatterDelegate) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "SetCVVOnCardInfo", Selector = "setCVVOnCardInfo:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCCardInfo) }, ParameterByRef = new bool [] { false })]
