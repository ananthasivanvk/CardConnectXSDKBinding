...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CCC_getAccounts", Selector = "CCC_getAccounts:", ParameterType = new Type [] { typeof (global::System.Action<NSArray<global::CardConnectBinding.CCCAccount>, NSError>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type [] { typeof (ObjCRuntime.Trampolines.NIDActionArity2V2) })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CCC_saveAccountToCustomer", Selector = "CCC_saveAccountToCustomer:completion:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCAccount), typeof (global::System.Action<global::CardConnectBinding.CCCAccount, NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V0) })]
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CCC_updateAccount", Selector = "CCC_updateAccount:completion:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCAccount), typeof (global::System.Action<global::CardConnectBinding.CCCAccount, NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V0) })]
