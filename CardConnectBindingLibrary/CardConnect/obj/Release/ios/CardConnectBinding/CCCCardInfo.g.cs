...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "AccountType", Selector = "accountType", PropertyType = typeof (CardConnectBinding.CCCCardIssuer), GetterSelector = "accountType", ArgumentSemantic = ArgumentSemantic.UnsafeUnretained)]
	...
	public static partial class CCCCardInfo_Extensions {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static CCCCardMaskFormat GetMaskFormat (this ICCCCardInfo This)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void SetMaskFormat (this ICCCCardInfo This, CCCCardMaskFormat value)
		{
			if (IntPtr.Size == 8) {
...
namespace CardConnectBinding {
	...
	public unsafe partial class CCCCardInfo : NSObject, ICCCCardInfo, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual CCCCardIssuer AccountType {
			[Export ("accountType", ArgumentSemantic.UnsafeUnretained)]
			get {
				CCCCardIssuer ret;
				if (IsDirectBinding) {
					if (IntPtr.Size == 8) {
					...
					if (IntPtr.Size == 8) {
						ret = (CCCCardIssuer) global::ApiDefinition.Messaging.Int64_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("accountType"));
					} else {
						ret = (CCCCardIssuer) global::ApiDefinition.Messaging.int_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("accountType"));
					}
				}
				return ret;
			}
