...
namespace CardConnectBinding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "PaymentController", Selector = "paymentController:finishedWithAccount:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCPaymentController), typeof (CardConnectBinding.CCCAccount) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidCancelPaymentController", Selector = "didCancelPaymentController:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCPaymentController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PaymentController", Selector = "paymentController:finishedApplePayWithResult:", ParameterType = new Type [] { typeof (CardConnectBinding.CCCPaymentController), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
